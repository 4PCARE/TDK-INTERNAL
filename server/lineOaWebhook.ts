...
กรุณาใช้ข้อมูลข้างต้นในการตอบคำถามอย่างเป็นธรรมชาติ ไม่ต้องกล่าวถึงว่าได้รับข้อมูลมาจากที่ใด`;
        console.log(
...
สำคัญ: 
- ตอบคำถามอย่างเป็นธรรมชาติและเป็นมิตร
- ไม่ต้องกล่าวถึงว่าได้รับข้อมูลหรือเอกสารมาจากที่ใด
- เมื่อผู้ใช้ถามเกี่ยวกับรูปภาพ ให้ใช้ข้อมูลการวิเคราะห์รูปภาพในการตอบคำถาม
- ตอบเป็นภาษาไทยเสมอ เว้นแต่ผู้ใช้จะสื่อสารเป็นภาษาอื่น
- ให้ข้อมูลที่ถูกต้องและเป็นประโยชน์อย่างเป็นมิตร
